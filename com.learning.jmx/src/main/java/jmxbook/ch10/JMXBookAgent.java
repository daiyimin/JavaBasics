 ...
 * Step 2. Open http://localhost:9092, open the MBean view of mlet
 * Step 3. Input file///C:/Users/eyimdai/Dropbox/Private/workspace/sourcecode/com.learning.jmx/src/main/java/jmxbook/ch10/ch10.mlet
 * in the getMBeansFromURL(), and invoke the method
 * Step 4. Check the new MBean hello1 in agent view
 * 
 * @author eyimdai
 */
 ...
 * Step 1. Run main in JMXBookAgent
 * Step 2. Open http://localhost:9092, open the MBean view of mlet
 * Step 3. Input file///C:/Users/eyimdai/Dropbox/Private/workspace/sourcecode/com.learning.jmx/src/main/java/jmxbook/ch10/ch10.jar
 * in the addURL(), and invoke the method
 * Step 4. Open Admin view 
 * Step 5. Input following fields
 * Domain: JMXBookAgent
 * Key: name=HelloWorld2
 * Java Class: jmxbook.ch10.jar.HelloWorld
 * Class Loader: JMXBookAgent:name=mlet
 * Step 6. Check the new MBean hello2 in agent view
 */
